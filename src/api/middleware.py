...
from src.common.collaboration_auth import CollaborationAuthService
...
class AuthMiddleware(BaseHTTPMiddleware):
    def __init__(
        self,
        app,
        auth_service: CollaborationAuthService = None,
    ) -> None:
        super().__init__(app)
        self.auth_service = auth_service or CollaborationAuthService()
