...
from src.common.config import validate_resource_limits
...
class ResourceLimits:
    ...
    def validate(self) -> None:
        limits = validate_resource_limits(self.to_dict())
        self.cpu_time = limits["cpu_time"]
        self.memory_mb = limits["memory_mb"]
        self.disk_mb = limits["disk_mb"]
